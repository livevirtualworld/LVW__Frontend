...
function TourDetails() {
  ...
  const [remainsNum, setRemainsNum] = useState([]);
          ...
          axios
            ...
            .then((bookres) => {
              ...
              for (let i = 0; i < bookres.data.length; i++) {
                num = num + bookres.data[i].numberOfGuests;
              }
              setRemainsNum(remains(num));
  ...
  const [removeIm, setRemoveIm] = useState(
    JSON.parse(localStorage.getItem("remove")) || []
  );
  useEffect(() => {
        ...
        <div className={style["container"]}>
          <div className={style["hero__content"]}>
            ...
            <div className={style["hero__icons"]}>
              ...
              {showCoverModal && (
                <div
                  className={UserCoverModalStyle["usercover-modal__overlay"]}
                >
                  <div
                  ...
                  >
                    ...
                    <div
                      className={UserCoverModalStyle["usercovermodal__input"]}
                    >
                      <input
                        type="file"
                        id="img"
                      ...
                      <div
                        className={
                          UserCoverModalStyle["usercovermodal__actions"]
                        }
                      >
          ...
          <div className={style["details__content"]}>
            <div className={style["details__about"]}>
              <div className={style["tabs"]}>
                ...
                <a
                  className={` ${tap === "reviews" ? style.active : ""}`}
                  onClick={() => {
                    setTap("reviews");
                  }}
                >
                ...
                <a
                  className={` ${tap === "instructions" ? style.active : ""}`}
                  onClick={() => {
                    setTap("instructions");
                  }}
                >
                ...
                <a
                  className={` ${tap === "media" ? style.active : ""}`}
                  onClick={() => {
                    setTap("media");
                  }}
                >
                ...
                <a
                  className={` ${tap === "similar" ? style.active : ""}`}
                  onClick={() => {
                    setTap("similar");
                  }}
                >
                ...
                <>
                  <div className={style["main-content"]}>
                    <div className={style["btns"]}>
                      <a>
                        <img src={icon} /> {tour?.address}
                      </a>
                      <a>
                        <img src={icon1} /> {tour?.hours} hours
                      </a>
                    ...
                    <div className={style["media"]}>
                      ...
                      {editMedia && (
                        <div
                          className={
                            UserCoverModalStyle["usercover-modal__overlay"]
                          }
                        >
                          <div
                            className={
                              UserCoverModalStyle["usercover-modal__content"]
                            }
                          >
                            <div
                              className={
                                UserCoverModalStyle["usercovermodal__header"]
                              }
                            >
                              <h2>Edit Media</h2>
                            </div>
                            <div
                              className={
                                UserCoverModalStyle["usercovermodal__input"]
                              }
                            >
                              <input
                                type="file"
                              ...
                              {mediaImagePreview && (
                                <img
                                  ...
                                  alt="Selected Media"
                                  className={
                                    UserCoverModalStyle["usercover-preview"]
                                  }
                                />
                              )}
                              <div
                              ...
                              >
                                <button onClick={() => setEditMedia(false)}>
                                  Cancel
                                </button>
                                <button
                                  onClick={() => handleEditMediaSaveChanges()}
                                >
                                  Save Changes
                                </button>
                              </div>
                        ...
                        <div className={style["stars"]}>
                          {[1, 2, 3, 4, 5].map((starIndex) => (
                            <span
                              ...
                              style={{
                                color:
                                  starIndex <= review.rate ? "gold" : "grey",
                              }}
                            ></span>
                          ))}
                          <h6>({review.rate})</h6>
                    ...
                    <div className={style["main-content"]}>
                      <div className={style["instruc__edit"]}>
                        ...
                        <div className={style["instruc__buttons"]}>
                          <button onClick={handleCancelInstructionsEdit}>
                            Cancel
                          </button>
                  ...
                  {editAllMedia && (
                    ...
                    >
                      ...
                      >
                        ...
                        {tour?.img.length > 0 && (
                          <div
                            className={style["media-preview-container"]}
                            style={{
                              display: "flex",
                              justifyContent: "space-between",
                              flexWrap: "wrap",
                    ...
                    {showRolesModal && (
                      <div className={BookingStyle["booking__modall__content"]}>
                        ...
                        <div className={BookingStyle["booking__modal__body"]}>
                          ...
                          <p>
                            1) If you need to cancel the tour you have booked,
                            you can do so up to 24 hours before the scheduled
                            tour date.
                          </p>
                          <p>
                            2) To request a tour cancellation, please contact us
                            at <span>LVW@support.com</span>. We will guide you
                            through the cancellation process and initiate a
                            refund if the trip was pre-paid.
                          </p>
                          <p>
                            3) There are no fees associated with the
                            cancellation process.
                          </p>
                          <div
                            className={BookingStyle["booking__modal__buttons"]}
                          >
                            <button
                              className={BookingStyle["booking__cancel__btn"]}
